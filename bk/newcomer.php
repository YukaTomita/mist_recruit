...
<body>
    ...
    <header class="header flex-box">
        <h1 class="site-title">
            <a href="#!">
                <img src="images/グループ 1315.png" alt="ロゴ">
            </a>
        </h1>
        <a href="#!"><img class="header-instagram" src="images/グループ 790.png" alt="Instagram"></a>
        <a href="#!"><img class="header-twitter" src="images/white background.png" alt="Twitter"></a>
    ...
    <!-- トップ画像と中央配置 -->
    <img src="images\グループ 1097.jpg" alt="画像">
    <div class="wrapper">
        ...
        <section id="ict-link" class="section__contents anchor center">
            <div class="contents__bg">
                ...
                <div class="contents__ict container" id="target2">
                    <img class="first-img" src="images/グループ 1098.jpg" alt="サンプル画像">
                    <div class="detail1">
                        <img class="open-img" src="images/グループ 1822.png" alt="サンプル画像">
                    </div>
                    <p class="newcomer-text">僕はラグビー<br>をしてました。</p>
                    <button class="newcomer-btn1">もっと見る</button>
                    <img class="first-img" src="images/グループ 1100.jpg" alt="サンプル画像">
                    <div class="detail2">
                        <img class="open-img" src="images/グループ 1819.png" alt="サンプル画像">
                    </div>
                    <p class="newcomer-text">僕はサッカー<br>をしてました。</p>
                    <button class="newcomer-btn2">もっと見る</button>
                    <img class="first-img" src="images/グループ 1101.jpg" alt="サンプル画像">
                    <div class="detail3">
                        <img class="open-img" src="images/グループ 1821.png" alt="サンプル画像">
                    </div>
        ...
        <div class="flex-img">
            <ul class="flex-ul">
                <li>
                    <img class="size-img" src="images/グループ 11.png" alt="画像">
                    <p>猪瀬</p>
                </li>
                <li>
                    <img class="size-img" src="images/グループ 3.png" alt="画像">
                    <p>岡崎</p>
                </li>
                <li>
                    <img class="size-img" src="images/グループ 3.png" alt="画像">
        ...
        <!-- エントリー -->
        <div class="entry">
            <P class="font-style-comments">まずはあなたのキャリアプランを聞かせてください。</P>
        ...
        <!-- リンク群 -->
        <div class="flex-link">
            <img class="link-img" src="images/グループ 1824.png">
            <img class="link-img" src="images/グループ 1826.png">
        </div>
        <div class="flex-link">
            <img class="link-img" src="images/グループ 1827.png">
            <img class="link-img" src="images/グループ 1828.png">
        </div>

        <!-- Instagram -->
        <img class="instagram" src="images/グループ 1098.png" alt="画像">

        <!-- グレー画像群 -->
        <div class="flex-link">
            <img class="silver" src="images/長方形 54.png" alt="画像">
            <img class="silver" src="images/長方形 54.png" alt="画像">
            <img class="silver" src="images/長方形 54.png" alt="画像">
        </div>
        <div class="flex-link">
